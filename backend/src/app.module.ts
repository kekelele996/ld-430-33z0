...
import { ReviewClaimController } from './controllers/reviewClaim.controller';
...
import { ReviewClaimEvent, ReviewClaimEventSchema } from './models/reviewClaimEvent.schema';
...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      ...
      { name: ReviewClaimEvent.name, schema: ReviewClaimEventSchema },
